...
export train_aug=/scratch/ba63/gender-rewriting/raw_openSub/augmentation/augmented_data/camera_ready_GID_CHECKPOINT_top_3/train.arin.tokens.augmented
export train_mm_aug=/scratch/ba63/gender-rewriting/raw_openSub/augmentation/augmented_data/camera_ready_GID_CHECKPOINT_top_3/train.ar.MM.tokens.augmented
export train_fm_aug=/scratch/ba63/gender-rewriting/raw_openSub/augmentation/augmented_data/camera_ready_GID_CHECKPOINT_top_3/train.ar.FM.tokens.augmented
export train_mf_aug=/scratch/ba63/gender-rewriting/raw_openSub/augmentation/augmented_data/camera_ready_GID_CHECKPOINT_top_3/train.ar.MF.tokens.augmented
export train_ff_aug=/scratch/ba63/gender-rewriting/raw_openSub/augmentation/augmented_data/camera_ready_GID_CHECKPOINT_top_3/train.ar.FF.tokens.augmented
...
# concat
cat $train_aug $train_aug $train_aug $train_aug > train.arin.tokens+train.arin.tokens+train.arin.tokens+train.arin.tokens
cat $train_mm_aug $train_fm_aug $train_mf_aug $train_ff_aug > train.ar.MM.tokens+train.ar.FM.tokens+train.ar.MF.tokens+train.ar.FF.tokens
