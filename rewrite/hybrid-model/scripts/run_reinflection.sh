...
--use_morph \
--use_seq2seq \
--seq2seq_model_path seq2seq_reinflector/saved_models/augmented_fix/ \
--top_n_best 5 \
--beam_width 10 \
--use_gpu \
--output_dir logs/paper_results/multi_user_with_clitics/augmentation/reinflection/CBR_filter+backoff+all+morph_newdb+mod_per_3rd_generator+neural_augmented_id_augmented_checking \
--analyze_errors \
--error_analysis_dir logs/paper_results/multi_user_with_clitics/augmentation/error_analysis/CBR_filter+backoff+all+morph_newdb+mod_per_3rd_generator+neural_augmented_id_augmented_checking
