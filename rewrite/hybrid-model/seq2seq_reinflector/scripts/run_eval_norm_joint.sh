...
export SYSTEM_HYP=logs/reinflection/multi_user_side_constraints_newdb/$DATA_SPLIT.joint+morph_beam_15.$DECODING.norm
...
printf "%s\n%s\n%-12s%s" "$m2_eval" "$accuracy" "BLEU" ": $bleu" > eval.$DECODING
