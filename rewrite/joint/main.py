...
class Vectorizer:
    ...
    @classmethod
    def create_vectorizer(cls, data_examples, first_person_only=False,
                          add_side_constraints=False):
        ...
        src_vocab_char = SeqVocabulary(first_person_only=first_person_only,
                                       add_side_constraints=add_side_constraints)
        src_vocab_word = SeqVocabulary(first_person_only=first_person_only,
                                       add_side_constraints=add_side_constraints)
...
class MT_Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        vectorized = self.vectorizer.vectorize(src, trg, src_label, trg_label,
                                               trg_gender)
        return vectorized
