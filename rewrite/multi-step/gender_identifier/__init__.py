...
_LABELS_MULTI_USER = ['1F+1F', '1F+2F', '1F+2M', '1F+B', '1M+1M', '1M+2F',
                      '1M+2M','1M+B', '2F+1F', '2F+1M', '2F+2F', '2F+B',
                      '2M+1F', '2M+1M', '2M+2M', '2M+B', 'B+1F', 'B+1M',
                      'B+2F', 'B+2M', 'B+B']

_LABELS_SINGLE_USER = ['B+B', '1F+B', '1M+B', 'B+1F', 'B+1M']
...
class GenderIdentifier:
    ...
    def __init__(self, model_path, single_user=False, use_gpu=True):
    ...
    @staticmethod
    def labels():
        """Get the list of word-level gender labels returned by predictions.
        Returns:
            :obj:`list` of :obj:`str`: List of word-level gender labels.
        """
        if self.single_user:
            return list(_LABELS_SINGLE_USER)
        else:
            return list(_LABELS_MULTI_USER)
    ...
    def predict(self, sentences, batch_size=32):
        """Predict the word-level gender labels of a list of sentences.
        Args:
            sentences (:obj:`list` of :obj:`list` of :obj:`str`): The input
                sentences.
            batch_size (:obj:`int`): The batch size.
        Returns:
            :obj:`list` of :obj:`list` of :obj:`str`: The predicted gender
    ...
    def predict_sentence(self, sentence):
        """Predict the gender labels of a single sentence.
        Args:
            sentence (:obj:`list` of :obj:`str`): The input sentence.
        Returns:
            :obj:`list` of :obj:`str`: The predicted gender
