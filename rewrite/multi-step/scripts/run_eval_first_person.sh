...
export EXPERIMENT=CBR_filter+backoff+all+morph_newdb+mod_per_3rd_generator+neural_test
export SYSTEM_HYP=logs/paper_results/first_person/reinflection/$EXPERIMENT
