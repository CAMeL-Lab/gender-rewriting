...
--beam_width 10 \
--use_gpu \
--output_dir logs/paper_results_with_mlm_ft/multi_user_with_clitics/augmentation/rewriting/CBR_filter+backoff+all+morph_newdb+mod_per_3rd_generator+neural_augmented_id_augmented_checking \
--analyze_errors \
--error_analysis_dir logs/paper_results_with_mlm_ft/multi_user_with_clitics/augmentation/error_analysis/CBR_filter+backoff+all+morph_newdb+mod_per_3rd_generator+neural_augmented_id_augmented_checking
