...
# for gid_model in /scratch/ba63/gender-rewriting/gender-id/CAMeLBERT_MSA/camera_ready/multi_user_with_clitics/augmented_models/5000/models_f1/checkpoint*
...
#     --use_morph \
#     --use_seq2seq \
#     --seq2seq_model_path neural_rewriter/saved_models/camera_ready \
#     --top_n_best 3 \
#     --beam_width 10 \
#     --use_gpu \
#     --output_dir $gid_model
